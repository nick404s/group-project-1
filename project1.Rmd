...
cat(paste0("The most recent area to have a confirmed case is ", last_recent_confirmed_df[1,2]))
...
sorted_by_risk_ascend <- om_risk_df[order(om_risk_df$risk_score, -om_risk_df$Confirmed),]
...
```
By seeing the drastic dispersion between the countries with the lowest and highest risk scores (0 and 18.7 respectively), it's apparent that most countries have relatively low risk scores, but some outlier countries have extremely high risk scores, pulling the global risk score up.
